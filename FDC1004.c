...
static int32_t FDC1004_capdac_values[] = { 0, 0, 0, 0 };
...
uint8_t FDC1004_read_measurement(uint8_t measurement, int32_t *result) {
	...
	int32_t res = ((int32_t)ATTOFARADS_UPPER_WORD) * m_raw_measurement;
	res += (int32_t)FDC1004_capdac_values[measurement] * FEMTOFARADS_CAPDAC * 1000;
